        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped" style="text-align: center">
                ...
                <tr>
                    ...
                    <th style="width:10%"></th>
                    <th style="width:10%"></th>
                    <th id="total_product" style="width:10%">{{$sum_total_product}}</th>
                    <th style="width:10%"></th>
                    <th style="width:10%"></th>
                    <th id="total_price" style="width:10%">{{number_format($sum_total_price)}}</th>
                    <th style="width:10%"></th>
    ...
    <script>
        $(document).ready(function(){
            $('#fillter_date').click(function () {
                ...
                $.ajax({
                    type:'POST',
                    url:'{{route('search_report_hoa_hong_user2')}}',
                    data:dt,
                    success:function(resultData){
                        // // $('.effort').val(resultData);
                        // console.log(resultData)
                        $('#table_body').html(resultData[0]);
                        $('#total_product').html(resultData[1]);
                        $('#total_price').html(resultData[2]);

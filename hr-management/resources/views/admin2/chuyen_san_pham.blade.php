                    ...
                    @foreach($product as $key => $value)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{route('view_chuyen_san_pham_warehouse',['id'=>$value->id])}}" data-remote="false"
                                   data-toggle="modal" data-target="#modal-admin-action-update" class="btn dropdown-item">
                                    <i class="fas fa-edit"> Chuyển Sản Phẩm</i>
                                </a>
                            </td>
                            <td>{{$value->name}}</td>
    ...
    <div class="modal fade" id="modal-admin-action-update">
        <div class="modal-dialog" >
            <div class="modal-content">
                ...
                <form action="{{route('action_warehouse_to_warehouse')}}" method="post">

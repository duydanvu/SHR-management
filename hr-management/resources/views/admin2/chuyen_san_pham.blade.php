...
{{--                    <button id = "" type="button" class="btn btn-info mt-4" data-toggle="modal" data-target="#modal-create-member"><i class="fas fa-plus-circle"></i> Chuyển Sản Phẩm</button>--}}
{{--                </div>--}}
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped" style="text-align: center">
                ...
                <tbody id="table_body">
                    <tr>
                        <td>1</td>
                        <td><a type="button" class="btn btn-info" data-toggle="modal" data-target="#modal-create-member">actions</td>
                        <td>Sản Phẩm 1</td>
                        <td>PDS001</td>
                        <td>Dịch Vụ</td>
                        <td>1000000</td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-sm-12">
                                    ...
                                    <div class="form-group">
                                        <label for="name">Kho tồn</label>
                                        <input id="phone" type="text" class="form-control @error('txtPhone') is-invalid @enderror" name="txtPhone" value=""  autocomplete="number" required>
                                        @error('txtPhone')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>

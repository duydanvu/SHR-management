        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item "><a >Báo Cáo Bán Hàng</a></li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped" style="text-align: center">
                <thead>
                    <tr>
                        <th style="width:5%">#</th>
                        <th style="width:15%" class="noSort">Thời Gian</th>
                        <th style="width:10%" >Sản Phẩm</th>
                        <th style="width:10%" >Nhà Cung Cấp</th>
                        <th style="width:10%" >Tổng Số Sản Phẩm</th>
                        <th style="width:10%">Tổng Tiền</th>
                        <th style="width:10%">Nhân Viên Bán</th>
                        <th style="width:10%">Tổng Hoa Hồng</th>
                ...
                <tr>
                    ...
                    <th style="width:10%" ></th>
                    <th id="total_product" style="width:10%;color: blue">{{$sum_total_product}}</th>
                    <th id="total_price" style="width:10%;color: blue">{{$sum_total_price}}</th>
                    <th style="width:10%"></th>
                    <th id="total_bonus" style="width:10%;color: blue">{{$sum_total_bonus}}</th>
                    <th style="width:10%"></th>
                </tr>
                </thead>
                <tbody id="table_body">
    ...
    <script>
        $(document).ready(function(){
            $('#fillter_date').click(function () {
                ...
                var dt = {_token,area_search,group_search,name_product,end_time,start_time};
                console.log(dt);
                $.ajaxSetup({
                    headers: {
                ...
                $.ajax({
                    type:'POST',
                    url:'{{route('search_report_sale_ad2')}}',
                    data:dt,

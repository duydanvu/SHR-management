    ...
    <div class="col-lg-12 col-sm-12">
        ...
        <div class="form-group">
            ...
            <div class="form-check">
                ...
                <input id="hoptac" type="radio" class="form-check-input ml-4" name="txtTypeHT" value="hoptac" @if($product->cooperation == 'hoptac') checked @endif autocomplete="number" required>

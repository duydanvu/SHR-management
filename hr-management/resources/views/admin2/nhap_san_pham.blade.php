...
<div class="row">
    ...
    <div class="col-lg-12 col-sm-12">
        ...
        <div class="form-group">
            ...
            <input id="phone" type="number" class="form-control @error('txtTotalImport') is-invalid @enderror" name="txtTotalImport" value=""  autocomplete="number" required>
            @error('txtTotalImport')
            <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
            @enderror

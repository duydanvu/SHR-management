...
<div class="modal-body">
    ...
    <input name="product_id" value="{{$image->id}}" hidden/>
    <div class="row">
        <div class="card-body col-lg-12 float-left">
            <div class="col-8">
            <span id="uploaded_image"><img id="img_prv_up" src="{{URL::to('/')}}{{$image->link}}" style="max-width: 250px;max-height: 300px; width: 200px;height: 250px"></span>
            </div>
            <div class="form-group col-4 float-left">
                <label class="pl-4" for="name">Tải Ảnh</label>

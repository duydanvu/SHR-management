        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item "><a >Quản lý Đối tác vận chuyển</a></li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-md-3 ml-4">
                    <div class="form-group">
                        ...
                        <label for="exampleInputEmail1">Tên Đối tác Vận Chuyển</label>
                ...
                <div class="col-md-3 ml-4 mt-md-2 " style="float: left">
                    <button id = "" type="button" class="btn btn-info mt-4" data-toggle="modal" data-target="#modal-create-member"><i class="fas fa-plus-circle"></i> Thêm Đối tác vận chuyển</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped" style="text-align: center">
                ...
                <tr>
                    ...
                    <th style="width:10%">Tên Đối tác vận chuyển</th>
    ...
    <div class="modal fade"  id="modal-create-member" >
        <div class="modal-dialog col-lg-8" >
            <div class="modal-content col-lg-12 ">
                <div class="modal-header">
                    <h4 class="modal-title">Tạo Đối Tác</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">

                ...
                @if(count($contract) > 0)
                    @foreach($contract as $key => $value)
                        <tr>
                            ...
                            <td><a href="{{route('view_user_of_contract',['id'=>$value->contract_id])}}">{{$value->sum_user}}</a></td>
    ...
    <div class="modal fade" id="modal-admin-action-update">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{route('update_information_contract')}}" method="post">
    ...
    <div class="modal fade" id="modal-create-store">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="{{route('add_new_contract')}}" method="post">
                    <div class="modal-body">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
